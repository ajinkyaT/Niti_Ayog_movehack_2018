...
#%%
import sys
#Change below lines according to your computer tensorflow installation
sys.path.append(r'C:\Program Files\Anaconda3\Lib\site-packages\tensorflow\contrib\slim')
sys.path.append(r'C:\Users\pradeepr\Desktop\Movehack_2018\IIIT_H\deeplab')
...
flags.DEFINE_enum('colormap_type', 'pascal', ['pascal', 'cityscapes','cityscapes_india'],

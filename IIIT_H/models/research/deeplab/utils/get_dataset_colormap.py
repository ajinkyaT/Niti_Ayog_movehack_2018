...
_PASCAL = 'pascal'
_CITYSCAPES_INDIA = 'cityscapes_india'
...
def create_cityscapes_india_label_colormap():
  """Creates a label colormap used in CITYSCAPES segmentation benchmark.
...
def get_cityscapes_india_name():
  return _CITYSCAPES_INDIA
...
def create_label_colormap(dataset=_PASCAL):
  ...
  elif dataset == _CITYSCAPES_INDIA:
    return create_cityscapes_india_label_colormap()
  else:

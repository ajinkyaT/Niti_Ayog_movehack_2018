...
import cv2
#%%
def read_model(cross='_rgb_channel_first_'):
    json_name = 'architecture_16_100_' + cross + '.json'
    weight_name = 'model_weights_16_100_' + cross + '.h5'
...
class_threshold = {1:0.9, 2:0.3, 3:0.3,4:0.8, 5:0.3, 6:0.4, 7:0.8, 8:0.8, 9:0.3, 10:0.3}
